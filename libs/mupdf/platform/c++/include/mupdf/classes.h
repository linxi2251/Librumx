...
struct PdfDocument
{
	 ...
	 */
	FZ_FUNCTION void pdf_count_q_balance(const PdfObj& res, const PdfObj& stm, int *underflow, int *overflow) const;
	...
	*/
	...
	FZ_FUNCTION int pdf_lookup_metadata(const char *key, char *ptr, int size) const;
