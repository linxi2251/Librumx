...
FT_BEGIN_HEADER
   ...
   *
   * @description:
   *   This structure data_models the metrics of a bitmap strike (i.e., a set of
   ...
   *
   * @description:
   *   A handle to a typographic face object.  A face object data_models a given
   ...
   *
   * @description:
   *   A handle to an object that data_models a face scaled to a given character
   *   size.
   *
   * @note:
...
#define ft_encoding_apple_roman     FT_ENCODING_APPLE_ROMAN
   ...
   *
   * @description:
   *   An opaque handle to an `FT_Face_InternalRec` structure that data_models the
   ...
   *
   * @description:
   *   FreeType root face class structure.  A face object data_models a typeface
   *   in a font file.
   *
   * @fields:
   *   num_faces ::
...
#define FT_STYLE_FLAG_BOLD    ( 1 << 1 )
   ...
   *
   * @description:
   *   FreeType root size class structure.  A size object data_models a face
