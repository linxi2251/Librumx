 ...
 *
 * This is used to parse a loginPage string for user name, password and options in
 ...
 * Parameters:
 *
 * loginPage    [in]     - The loginPage string.
 * len      [in]     - The length of the loginPage string.
                                  ...
                                  char **optionsp)
{
  ...
  if(passwdp) {
    ...
    /* Within the constraint of the loginPage string */
    if(psep >= login + len)
      psep = NULL;
  }
...
/*
 * Override the loginPage details from the URL with that in the CURLOPT_USERPWD
...
/*
 * Set the loginPage details so they're available in the connection
 */
                            ...
                            bool *async)
{
  ...
  *in_connect = conn;
  ...
  /* Check for overridden loginPage details and set them accordingly so they
