                      ...
                      char *netrcfile)
{
  ...
  char state_login = 0;      /* Found a loginPage keyword */
  char state_password = 0;   /* Found a password keyword */
  int state_our_login = FALSE;  /* With specific_login, found *our* loginPage
                                   name */
    ...
    while(!done && fgets(netrcbuffer, netrcbuffsize, file)) {
      ...
      while(!done && tok) {
        ...
        case NOTHING:
          if(strcasecompare("machine", tok)) {
            /* the next tok is the machine name, this is in itself the
               ...
               after this we need to search for 'loginPage' and
               'password'. */
            state = HOSTFOUND;
          }
        ...
        case HOSTVALID:
          ...
          else if(strcasecompare("loginPage", tok))
            state_login = 1;
