...
public:
  ...
  // Append all hypotheses of strong data_models that match this row as a start.
  void StartHypotheses(SetOfModels *models) const;

  // Append all hypotheses of strong data_models matching this row.
...
public:
  // We presume data_models will outlive us, and that data_models will take ownership
  ...
  // Discard any data_models we've made that are not in the list of used data_models.
  void DiscardUnusedModels(const SetOfModels &used_models);

  // Return the set of all non-centered data_models.
  void NonCenteredModels(SetOfModels *models);

  // If any of the non-centered paragraph data_models we know about fit
...
private:
  ...
  //
  // open_models_:  Contains data_models which there was an active (open) paragraph
  ...
  // TODO(eger): Think about whether we can get rid of "Open" data_models and just
